...
class PosterPageScreen extends StatelessWidget {
  ...
  String district;
  String panchayath;
  String ward,loginUserPhone;
  String loginUsername,loginUserID,subScriberType;
  PosterPageScreen({Key? key, required this.amount,
    required this.district, required this.panchayath,
    required this.ward,required this.loginUsername,
                    ...
                    child: Stack(
                      children: [
                        ...
                        SizedBox(
                          ...
                          width: 340,
                          child:
                          amount>=100000&& amount<=199999?  Image.asset("assets/1lack.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          amount>=200000&& amount<=299999? Image.asset("assets/2lack.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          amount>=300000 && amount<=399999? Image.asset("assets/3lack.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          amount>=400000 && amount<=499999? Image.asset("assets/4lack.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          amount>=500000? Image.asset("assets/5lack.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,):
                          const SizedBox(),
                        ),
                        Positioned(
                          top: district=="FAMILY CONTRIBUTION"?220:210,
                            left:amount>=200000?1: 60,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    width: 340,
                                    child: Text(ward,style:  TextStyle(fontSize:ward.length>20?10:14,fontWeight: FontWeight.bold, fontFamily: 'Montserrat',color: Colors.white),)
                                ),
                                ...
                                SizedBox(
                                    ...
                                    child: Row(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                        panchayath=="FAMILY CONTRIBUTION"?SizedBox(): SizedBox(
                                          width: width * .55,
                                            child: Center(child: Text(panchayath,style:  TextStyle(fontSize:panchayath.length>20? 11:10,fontWeight: FontWeight.w600, fontFamily: 'Montserrat',color: Colors.white),))),
          ...
          SizedBox(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                leading: InkWell(
                  onTap: () {
                    callNextReplacement( HomeScreenNew(subScriberType: subScriberType,loginUserID: loginUserID,
                        loginUsername: loginUsername,loginUserPhone: loginUserPhone,
