...
class TopPanchayathReport extends StatelessWidget {
  ...
  String equipmentAmount,sponsorPatientAmonut,foodkitAmount;
   TopPanchayathReport({Key? key,required this.loginUsername,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Top 100 Panchayath',style: wardAppbarTxt),
                      ),
                              ...
                              child: ListTile(
                                leading: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                        top:11,
                                        left: index+1>=100?9:18,
                                        child: SizedBox(width: index+1>=100?50:25,
                                            // color:Colors.red,
                                            child: Center(
