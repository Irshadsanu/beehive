...
class QuotaCompletedScreen extends StatelessWidget {
  ...
  QuotaCompletedScreen({Key? key, required this.district,
    required this.panchayath, required this.ward,
                    ...
                    child: Stack(
                      children: [
                        ...
                        SizedBox(
                          ...
                          width: 340,
                          child:
                          Image.asset("assets/Quota.jpg",fit: BoxFit.fill,alignment: Alignment.bottomCenter,)
