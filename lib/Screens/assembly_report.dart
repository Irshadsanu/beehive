...
class AssemblyReport extends StatelessWidget {
  ...
  String from; String loginUsername,loginUserID,subScriberType,loginUserPhone;
   AssemblyReport({Key? key,required this.from,required this.loginUsername
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                          onTap: (){
                            callNextReplacement(HomeScreenNew(loginUserPhone: loginUserPhone,loginUserID: loginUserID,
